...
import ConflictosGymkana from '../components/admin/ConflictosGymkana';
...
export default function AdminPage() {
  ...
  const cargarTodo = useCallback(() => {
    ...
    Promise.all([
      ...
      .catch(() => showToast('No se pudo cargar la información del Admin', 'error'))
        ...
        <div className="flex px-4 gap-1">
          {TABS.map((t) => (
            <button
              ...
              } ${t.id === 'conflictos' && conflictos.length > 0 ? 'relative' : ''}`}
            >
              {t.label}
      ...
      <main className="max-w-3xl mx-auto px-4 py-6">
        {cargando ? (
          ...
          <>
            ...
            {tab === 'conflictos' && (
              <ConflictosGymkana conflictos={conflictos} onCambio={cargarTodo} />
            )}
